        ...
        switch(userRole) {
            ...
            case 'administrador':
                return [
                    ...
                    { name: 'Emociones', icon: (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 9l-2 2m0 0l-2-2m2 2v6" />
                            </svg>
                ...
                <div style={{ 
                    ...
                    {!isCollapsed && (
                        <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: '12px', color: '#81D4FA', textTransform: 'capitalize' }}>
                                {userRole}
                            </p>
